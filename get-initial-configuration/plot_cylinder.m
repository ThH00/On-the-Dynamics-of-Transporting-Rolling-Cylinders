function [diskt,diskb,cylinder_axis,sides,pointA,pointP] ...
    = plot_cylinder(R,h,x1,x2,x3,psi,theta,phi,cylinder_color,helix_color)
...
pointA = plot3(xcirct(1),ycirct(1),zcirct(1),'linewidth',15,...
    'color','red','marker','.');
% contact point path (P)
xP = [x1;x2;x3]-h/2*e3-R*e2pp;
pointP = plot3(xP(1),xP(2),xP(3),'linewidth',5,'color','black',...
    'marker','.');
% helix on cylinder
