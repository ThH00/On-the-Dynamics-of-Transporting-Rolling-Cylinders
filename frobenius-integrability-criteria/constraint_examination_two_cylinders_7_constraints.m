...
%% Constraint: Cylinders I and II are in contact
A = [1, -dot(I_e3,II_e3);
    -dot(I_e3,II_e3), 1];
B = [dot(II_q-I_q,I_e3);
    dot(I_q-II_q,II_e3)];
...
common_normal = cross(I_e3,II_e3);
Pi(7) = dot(v_slip,common_normal/norm(common_normal));
% Pi(7) = dot(I_q'+pi_2-II_q'-pi_3,v_slip)/(r+r);
